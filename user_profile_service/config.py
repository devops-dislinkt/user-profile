...
database = os.environ["DATABASE_SCHEMA"] if "DATABASE_PASSWORD" in os.environ  else "postgres"
...
KAFKA_TOPIC = os.environ["KAFKA_TOPIC"] if "KAFKA_TOPIC" in os.environ else "default_topic"
