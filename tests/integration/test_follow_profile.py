...
class TestFollowProfile:
    ...
    def test_follow_public_profile(self, client: FlaskClient):
        response = client.post(
            "/api/profile/follow",
            json={
                "logged_in_user": PRIVATE_PROFILE_USER_1,
                "user_to_follow": PUBLIC_PROFILE_USER,
            },
        )
    ...
    def test_follow_private_profile(self, client: FlaskClient):
        response = client.post(
            "/api/profile/follow",
            json={
                "logged_in_user": PUBLIC_PROFILE_USER,
                "user_to_follow": PRIVATE_PROFILE_USER_1,
            },
        )
