...
def seed_db():
    profiles = [
        Profile(username=PUBLIC_PROFILE_USER, email='john@gmail.com', first_name='John', last_name='Smith', phone_number='+938480', date_of_birth='12.04.1995.',biography='Lorem',private=False),
